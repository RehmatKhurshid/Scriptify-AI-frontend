        ...
        <aside className={styles.sidebar}>
            <div className={styles.sidebarHeader}>
                <h1 className={styles.brand}>
                    <span className={styles.brandLine1}>Scriptify</span>
                    <span className={styles.brandLine2}>AI</span>
                </h1>
                <span className={styles.tagline}>Editorial Admin</span>
            </div>
            ...
            <div className={styles.sidebarFooter}>
                <Link to="/create" className={styles.createBtn} style={{ textDecoration: 'none' }}>
                    <Plus size={18} />
